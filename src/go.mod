module xmservice.com/xmservice.go
...
replace xmservice.com/api => ./api

require (
	github.com/fvbock/endless v0.0.0-20170109170031-447134032cb6
	github.com/gin-gonic/gin v1.8.2
	xmservice.com/api v0.0.0-00010101000000-000000000000
	xmservice.com/kafka v0.0.0-00010101000000-000000000000
)
...
require (
	...
	xmservice.com/auth v0.0.0-00010101000000-000000000000 // indirect
	...
	xmservice.com/services v0.0.0-00010101000000-000000000000 // indirect
)

replace xmservice.com/auth => ./auth

replace xmservice.com/kafkaservice => ./kafka-service
